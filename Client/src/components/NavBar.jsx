        ...
        <nav className="bg-gray-300 p-6 shadow-md border-b border-gray-200">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <ul className="flex space-x-4">
                    <li>
                        <Link to="/home" className={`text-lg transition-all duration-300 ${location.pathname === "/home" ? "text-indigo-700 font-bold text-xl" : "text-gray-700 font-semibold hover:text-gray-400"}`}>
