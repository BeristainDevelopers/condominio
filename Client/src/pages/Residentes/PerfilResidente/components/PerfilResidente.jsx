...
export const PerfilResidente = () => {
    const [residente, setResidente] = useState(residenteMockInicial);
    const [modalAbierto, setModalAbierto] = useState(false);
    const [loading, setLoading] = useState(true);

    const actualizarResidente = (nuevoResidente) => {
                ...
                >
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <div className="flex items-center mt-1 space-x-2 text-sm text-gray-600">
                                <MdHouse size={20} />
                                <span>Casa #{residente.id_casa}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-6 space-y-4 text-sm text-gray-700">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <span>
                                ...
                                <span
                                    ...
                                    residente.es_representante ? "text-green-600" : "text-red-600"
                                    }`}
                                >
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <span>
                                ...
                                <span
                                    className={`font-semibold ${
                                    residente.activo ? "text-green-600" : "text-red-600"
                                    }`}
                                >
